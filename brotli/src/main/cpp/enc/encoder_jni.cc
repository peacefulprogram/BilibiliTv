...
Java_org_zero_brotlilib_enc_EncoderJNI_nativeCreate(
...
Java_org_zero_brotlilib_enc_EncoderJNI_nativePush(
 ...
 */
JNIEXPORT jobject JNICALL
Java_org_zero_brotlilib_enc_EncoderJNI_nativePull(
        JNIEnv *env, jobject /*jobj*/, jlongArray ctx) {
    jlong context[5];
    env->GetLongArrayRegion(ctx, 0, 5, context);
    EncoderHandle *handle = getHandle(reinterpret_cast<void *>(context[0]));
 ...
 */
JNIEXPORT void JNICALL
Java_org_zero_brotlilib_enc_EncoderJNI_nativeDestroy(
        JNIEnv *env, jobject /*jobj*/, jlongArray ctx) {
    jlong context[2];
